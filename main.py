...
if REMONTE_et_AGREGE_DONNEES_ENQUETE_VF:
    TEST_MULTI_VF=False
    AGREGATION_VF=True
    ...
    if AGREGATION_VF:
        ...
        distance_max_en_m=200.0
        gdf_clustered = (
            gpd_maisons
            .groupby(["code_agent", "date_visite"], group_keys=False)
            .apply(cluster_one_group, eps=distance_max_en_m)
...
if REMONTE_DONNEES_AGREGEES_VF:
    ...
    print(f'TABLE {nom_table_enquetes_agregees} LOADED')
    print(f'->{len(gpd_maisons)}')
